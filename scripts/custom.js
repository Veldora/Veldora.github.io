...
$(window).load(function() {
    ...
    if (window.innerWidth <= 992) {
        $('nav.navbar.bg-color1').css("background-color", "rgba(37, 40, 48, 0)");
    }
//------------------------------------------------------------------------
//						COUNTER SCRIPT
//------------------------------------------------------------------------
...
//------------------------------------------------------------------------ 		
	$(window).scroll(function () {
        ...
        if (window.innerWidth <= 992) {
            ...
            var rVal = scVal > threshhold ? threshhold : scVal;
            $('nav.navbar.bg-color1').css("background-color", "rgba(37, 40, 48, " + (rVal / threshhold) + ")");
        }
    });

    $("#trigger-opacity-btn").on('click', function() {
        $('nav.navbar.bg-color1').css("background-color", "rgba(37, 40, 48, 1)");
    });
